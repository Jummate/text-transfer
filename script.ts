...
let entry = document.getElementById("entry") as HTMLTextAreaElement;
let peek = document.querySelector(".peek-icon") as HTMLSpanElement;
let closeOverlay = document.querySelector("#close") as HTMLSpanElement;
let overlay = document.querySelector("#overlay") as HTMLDivElement;
let descriptionContainer = document.querySelector("#ctn-description") as HTMLDivElement;
let clear = document.getElementById("clear") as HTMLButtonElement;
let description = document.getElementById("description") as HTMLInputElement;
let successMsg = document.getElementById("success-msg") as HTMLSpanElement;
let errorMsg = document.getElementById("error-msg") as HTMLSpanElement;
...
const pagination = (dataSource:any, pageWidth:number = 2) => {
    
    let paginationContainer = document.querySelector("#paginationContainer") as HTMLDivElement;
    let pageNumHolder = document.querySelector("#pageNumHolder") as HTMLSpanElement;
    
    let next = document.querySelector("#next") as HTMLButtonElement;
    let prev = document.querySelector("#prev") as HTMLButtonElement;
    let tableBody = document.querySelector("tbody") as any;
    ...
    pageNumHolder.addEventListener("click", (event:any)=>{
...
const createRow = (subData: { id: number, user_text: string, description: string, timestamp: string }): string => {

    const { id, user_text, description, timestamp } = subData;

    let newRow: any = '<tr scope="row" class="tableRow">';
    let formattedTimestamp :any = timestamp.split(" ");
...
const populateTable = (data: any): void => {
    let tableBody = document.querySelector("tbody") as any;
    tableBody.innerHTML = "";
...
const searchText = () => {
    ...
    let searchKeyWords = document.querySelector("#search") as HTMLInputElement;
...
let form = document.querySelector("#user-entry") as HTMLFormElement;
...
let slideRight = document.querySelector("#slideRight") as HTMLButtonElement;
let slideLeft = document.querySelector("#slideLeft") as HTMLButtonElement;

slideRight.addEventListener("click", ()=>{
    let textTable = document.querySelector("#text-table") as HTMLDivElement;
